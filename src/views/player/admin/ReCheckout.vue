<template>
    <div class="container">
        <div class="row py-3 justify-content-center">
            <div class="col-8 bg-white py-3 px-5 border rounded-3 noto-serif-tc lh-lg">
                <div class="py-4">
                    ...
                    <div class="d-flex">
                        <svg fill="#666666" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="23">
                ...
                <div class="py-4 fw-bold lh-lg w-80">
                    ...
                    <p class="text-grey66">
                        <span style="width: 80px" class="d-inline-block text-black">姓名</span>{{ formData.userName }}
                    </p>
                    <hr />
                    <p class="text-grey66">
                        <span class="pe-3 text-black">聯絡電話</span>{{ formData.phoneNum }}
                    </p>
                    <hr />
                    <p class="text-grey66">
                        <span class="pe-3 text-black">報名人數</span>{{ formData.personNum }} 人
                    </p>
                    <hr />
                    <p class="text-grey66">
                        <span style="width: 80px" class="d-inline-block text-black">備註</span>{{ formData.note }}
                    </p>
                    <hr />
                    <p class="text-danger">
                        <span class="pe-3 text-black">付款金額</span>{{ formData.payPrice }} 元
                    </p>
                </div>
                <div class="d-flex justify-content-center pb-4 gap-3">
                    <button type="button" class="fw-bold btn btn-outline-primary px-4" @click="goBack">
                        返回修改
                    </button>
                    <router-link :to="{ name: 'CheckoutSuccess' }"
                        class="btn btn-primary fw-bold px-4">完成結帳</router-link>
                </div>
            </div>
        </div>
    </div>
