<template>
    <div class="sign-up">
        <div class="sign-up__section">
            <div class="sign-up__role sign-up__role--store">
                <div class="sign-up__card">
                    <h3>店家註冊</h3>
                    <p>我要成為始祖聚人，<br />創造源源不絕的聚人!</p>
                    <div class="sign-up__controller">
                        <router-link class="d-block mb-2" to="/store/signup">
                            <button>立即註冊</button>
                        </router-link>
        ...
        <div class="sign-up__section">
            <div class="sign-up__role sign-up__role--player">
                <div class="sign-up__card">
                    <h3>玩家註冊</h3>
                    <p>我要成為GG的聚人，<br />希望可以來個Good Game!</p>

                    <div class="sign-up__controller">
                        <router-link class="d-block mb-2" to="/player/signup">
                            <button>立即註冊</button>
                        </router-link>
