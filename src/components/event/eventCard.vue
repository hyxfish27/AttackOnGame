    ...
    <div class="col-6 col-lg-3 mb-3 event-card cursor">
        <div class="card h-100 p-2">
            <div class="position-relative pt-150per event-card-img-wrap">
                <div class="py-1 px-2 z-1 position-absolute top-0 fs-10 noto-serif-tc"
                ...
                <img ref="image" class="w-100 h-100 inset-0 object-fit-cover position-absolute"
                    :src="computedEventData.eventImageUrl" :alt="computedEventData.title" />
            </div>
            ...
            <div class="card-body p-2">
                ...
                <div style="" class="bg-greyE9 rounded-1 pb-2 mb-2 position-relative">
                    <div class="position-absolute h-100 start-0 rounded-4" :class="computedEventData.barColor" :style="{
                        right: lineStyle(
