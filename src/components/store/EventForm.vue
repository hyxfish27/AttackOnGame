        ...
        <div class="d-flex gap-3">
            <div class="mb-3 w-50">
                ...
                <v-field
                    ...
                    :disabled="!conEdit"
                    :class="{ 'is-invalid': errors['registrationStartTime'] }"
                ></v-field>
                <error-message
                    name="registrationStartTime"
                    class="text-danger"
        ...
        <div class="d-flex gap-3">
            ...
            <div class="mb-3 w-50">
                ...
                <v-field
                    ...
                    @blur="
                        minNum(myData.minParticipants, formData.maxParticipants)
                    "
                ></v-field>
                <error-message
                    name="minParticipants"
